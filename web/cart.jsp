                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="cart" items="${sessionScope.cartlist}" varStatus="status">
                        <tr height="30px">
                            ...
                            <td class="no-wrap" title="${cart.name}"><div class="cn">${cart.name}</div></td>
                            <td>${cart.descn}</td>
                            <td>${cart.price}</td>
                            <td><input type="text" name="purchasenum<%=i %>" class="purchasenum" value="${cart.purchasenum}" size="6" onblur="check()">
                            </td>
                            <td>${cart.price*cart.purchasenum}</td>
                            <td>${cart.address}</td>
                            <td><a href="doremovecart?productid=${cart.productid}">remove
                            </a></td>
                        </tr>
                        <%
                            i++;
